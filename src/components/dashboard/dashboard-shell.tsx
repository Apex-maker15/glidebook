...
import { ArrowSquareOut, Bank, CalendarDots, ChatCircle, Check, Copy, Gear, Palette, ShieldCheck, SignOut, SquaresFour, Toolbox, Wrench } from "@/components/icons";
...
const NAV = [
  { href: "/dashboard", label: "Schedule", icon: SquaresFour },
  { href: "/dashboard/services", label: "Services", icon: Wrench },
  { href: "/dashboard/availability", label: "Availability", icon: CalendarDots },
  { href: "/dashboard/page", label: "Your page", icon: Palette },
  { href: "/dashboard/payments", label: "Payments", icon: Bank },
  { href: "/dashboard/settings", label: "Settings", icon: Gear },
  { href: "/dashboard/setup", label: "Get set up", icon: Toolbox },
];
    ...
    <div className="min-h-dvh lg:grid lg:grid-cols-[240px_minmax(0,1fr)]">
      <aside className="sticky top-0 z-30 flex items-center justify-between gap-3 border-b border-line bg-bg/85 px-4 py-3 backdrop-blur-xl lg:h-dvh lg:self-start lg:flex-col lg:items-stretch lg:justify-start lg:border-b-0 lg:border-r lg:px-4 lg:py-6">
        ...
        <div className="hidden lg:mt-auto lg:block">
          ...
          <p className="mt-3 flex gap-3 px-3 text-[11px] text-ink-muted">
